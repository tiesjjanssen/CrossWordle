...
public class Wordles { // ONLY ONE CLASS DEFINITION

    // --- Wordle CONSTANTS (SIZE=5 for grid, but targetWord is 4) ---
    private static final int MAX_ROWS = 5; // Grid size (number of guesses)
    private static final int MAX_COLS = 5; // Grid size (word length)
    ...
    private static final int WORD_LENGTH = 5; // Use target word length
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(() -> {
            new Wordles(); // The constructor calls createAndShowGUI()
        });
    }
}